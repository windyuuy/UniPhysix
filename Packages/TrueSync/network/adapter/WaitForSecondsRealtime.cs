...
namespace fsync
{
	...
	/// </summary>
	public class WaitForSecondsRealtime : IEnumerator, ITimerWaiter
	{
		...
		public WaitForSecondsRealtime(TSFloat duration)
		{
			this.startTime = sharedTimer.realtimeSinceStartup;
